...
## `augurs-prophet` - [0.10.2](https://github.com/grafana/augurs/compare/augurs-prophet-v0.10.1...augurs-prophet-v0.10.2) - 2025-11-27

### Other
- update Cargo.toml dependencies

## `augurs-outlier` - [0.10.2](https://github.com/grafana/augurs/compare/augurs-outlier-v0.10.1...augurs-outlier-v0.10.2) - 2025-11-27

### Fixed
- assert that data is rectangular in DBSCAN preprocessing ([#366](https://github.com/grafana/augurs/pull/366))

## `augurs-forecaster` - [0.10.2](https://github.com/grafana/augurs/compare/augurs-forecaster-v0.10.1...augurs-forecaster-v0.10.2) - 2025-11-27
