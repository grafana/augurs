...
## `augurs-prophet` - [0.9.1](https://github.com/grafana/augurs/compare/augurs-prophet-v0.9.0...augurs-prophet-v0.9.1) - 2025-02-26

### Other
- *(deps)* update ureq requirement from 2.10.1 to 3.0.0 (#245)
- *(deps)* update wasmtime requirement from 28 to 29 (#247)

## `augurs-outlier` - [0.9.1](https://github.com/grafana/augurs/compare/augurs-outlier-v0.9.0...augurs-outlier-v0.9.1) - 2025-02-26

### Added
- *(outlier)* add setters for parameters (#253)
