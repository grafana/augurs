...
const DtwFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_dtw_free(ptr >>> 0, 1));
/**
...
export class Dtw {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Dtw.prototype);
        obj.__wbg_ptr = ptr;
        DtwFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        DtwFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_dtw_free(ptr, 0);
    }
    /**
    ...
    */
    constructor(distanceFunction, opts) {
        const ret = wasm.dtw_new(addHeapObject(distanceFunction), isLikeNone(opts) ? 0 : addHeapObject(opts));
        this.__wbg_ptr = ret >>> 0;
        DtwFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    * @returns {Dtw}
    */
    static euclidean(opts) {
        const ret = wasm.dtw_euclidean(isLikeNone(opts) ? 0 : addHeapObject(opts));
        return Dtw.__wrap(ret);
    }
    /**
    ...
    * @returns {Dtw}
    */
    static manhattan(opts) {
        const ret = wasm.dtw_manhattan(isLikeNone(opts) ? 0 : addHeapObject(opts));
        return Dtw.__wrap(ret);
    }
    /**
    ...
    */
    distance(a, b) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dtw_distance(retptr, this.__wbg_ptr, addHeapObject(a), addHeapObject(b));
    ...
    */
    distanceMatrix(series) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dtw_distanceMatrix(retptr, this.__wbg_ptr, addHeapObject(series));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_set_2ba50dc715327edc = function(arg0, arg1, arg2) {
        getObject(arg0).set(getObject(arg1), arg2 >>> 0);
    };
    imports.wbg.__wbg_length_a9e7e8ccaa5e7434 = function(arg0) {
        const ret = getObject(arg0).length;
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('dtw_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
