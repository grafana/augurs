...
export function ets(periods, options) {
    try {
        ...
        wasm.ets(retptr, addHeapObject(periods), isLikeNone(options) ? 0 : addHeapObject(options));
...
const MSTLFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mstl_free(ptr >>> 0, 1));
/**
* A MSTL model.
*/
export class MSTL {
    ...
    * @param {ETSOptions | undefined} [options]
    */
    constructor(trend_forecaster, periods, options) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mstl_new(retptr, addHeapObject(trend_forecaster), addHeapObject(periods), isLikeNone(options) ? 0 : addHeapObject(options));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            this.__wbg_ptr = r0 >>> 0;
            MSTLFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('mstl_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
