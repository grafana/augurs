...
const DbscanClustererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_dbscanclusterer_free(ptr >>> 0, 1));
/**
...
export class DbscanClusterer {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        DbscanClustererFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_dbscanclusterer_free(ptr, 0);
    }
    /**
    * Create a new DBSCAN instance.
    * @param {DbscanOptions} opts
    */
    constructor(opts) {
        const ret = wasm.dbscanclusterer_new(addHeapObject(opts));
        this.__wbg_ptr = ret >>> 0;
        DbscanClustererFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    * @param {number[][] | Float64Array[]} distanceMatrix
    * @returns {Int32Array}
    */
    fit(distanceMatrix) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.dbscanclusterer_fit(retptr, this.__wbg_ptr, addHeapObject(distanceMatrix));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('clustering_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
