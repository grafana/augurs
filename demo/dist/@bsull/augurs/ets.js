...
const AutoETSFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_autoets_free(ptr >>> 0, 1));
/**
    ...
    */
    constructor(seasonLength, spec) {
        try {
            ...
            this.__wbg_ptr = r0 >>> 0;
            AutoETSFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('ets_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
