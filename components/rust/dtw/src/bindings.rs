            ...
            pub mod dtw {
                ...
                impl ::core::fmt::Debug for DtwOpts {
                    fn fmt(
                        ...
                        f.debug_struct("DtwOpts").field("window", &self.window).finish()
                    }
                }
                /// A sequence of floats comprising a time series.
                pub type Series = _rt::Vec<f64>;
                ...
                pub unsafe fn _export_static_dtw_euclidean_cabi<T: GuestDtw>(
                    ...
                    let result0 = T::euclidean(
                        match arg0 {
                            0 => None,
                            1 => {
                                let e = DtwOpts { window: arg1 as u32 };
                                Some(e)
                            }
                ...
                macro_rules! __export_augurs_dtw_dtw_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        export_static_dtw_euclidean(arg0 : i32, arg1 : i32,) -> i32 {
                        $($path_to_types)*:: _export_static_dtw_euclidean_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Dtw > (arg0, arg1) } #[export_name
                        = "augurs:dtw/dtw#[static]dtw.manhattan"] unsafe extern "C" fn
                        export_static_dtw_manhattan(arg0 : i32, arg1 : i32,) -> i32 {
                        $($path_to_types)*:: _export_static_dtw_manhattan_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Dtw > (arg0, arg1) } #[export_name
                        = "augurs:dtw/dtw#[method]dtw.distance"] unsafe extern "C" fn
                        export_method_dtw_distance(arg0 : * mut u8, arg1 : * mut u8, arg2
                        : usize, arg3 : * mut u8, arg4 : usize,) -> f64 {
                        $($path_to_types)*:: _export_method_dtw_distance_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::Dtw > (arg0, arg1, arg2, arg3,
                        arg4) } #[export_name =
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:augurs:dtw:component:encoded world"]
#[doc(hidden)]
...
A\x02\x01B\x12\x01r\x01\x06windowy\x04\0\x08dtw-opts\x03\0\0\x01pu\x04\0\x06seri\
es\x03\0\x02\x04\0\x03dtw\x03\x01\x01k\x01\x01i\x04\x01@\x01\x04opts\x05\0\x06\x04\
\0\x15[static]dtw.euclidean\x01\x07\x04\0\x15[static]dtw.manhattan\x01\x07\x01h\x04\
\x01@\x03\x04self\x08\x01s\x03\x01t\x03\0u\x04\0\x14[method]dtw.distance\x01\x09\
\x01p\x03\x01pu\x01p\x0b\x01@\x02\x04self\x08\x06series\x0a\0\x0c\x04\0\x1b[meth\
od]dtw.distance-matrix\x01\x0d\x04\x01\x0eaugurs:dtw/dtw\x05\0\x04\x01\x14augurs\
:dtw/component\x04\0\x0b\x0f\x01\0\x09component\x03\0\0\0G\x09producers\x01\x0cp\
